...
public class UserDao {
    ...
    public int getUsersCount() {
        try (PreparedStatement ps = connection.prepareStatement(GET_USERS_COUNT)) {
    ...
    public void registration(String email, String firstname, String lastname, String phoneNum, String password,
        ...
        try (PreparedStatement ps = connection.prepareStatement(CHECK_USER_EMAIL)) {
    ...
    public void toBlockUser(UserStatus action, String userId) {
        try (PreparedStatement ps = connection.prepareStatement(CHANGE_USER_STATUS)) {
